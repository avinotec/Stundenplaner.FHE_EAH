 ...
 */
public abstract class IdPickerMoses extends LinearLayout {
    ...
    protected IdPickerMoses(final Context context, final AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
    ...
    public void setOnItemChosenListenerMoses(final OnItemChosenListenerMoses _Listener) {
        mListenerMoses = _Listener;
    }
    ...
    protected void onFinishInflate() {
        ...
        mHeadlineView = findViewById(R.id.idPickerHeadline);
        mContentView = findViewById(R.id.idPickerContent);
    ...
    void openStringPicker() {
        ...
        final IdStringDialogMoses dialog = new IdStringDialogMoses();
    ...
    private List<IdItemMoses> buildItemList() {
        final ArrayList<IdItemMoses> items = new ArrayList<>();
    ...
    private final OnItemChosenListenerMoses mItemChosenListener = new OnItemChosenListenerMoses() {
        @Override
    ...
    OnItemChosenListenerMoses mListenerMoses;
