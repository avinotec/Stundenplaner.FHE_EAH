...
public class NewsCategoryAdapter extends BaseAdapter {
    ...
    public NewsCategoryAdapter(final Context mContext, final NewsCategoryVo[] mItems) {
     ...
     */
    @Override
    public NewsCategoryVo getItem(final int position) {
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        if(convertView == null) {
            ...
            viewHolder.mCategoryName = (TextView) convertView.findViewById(android.R.id.text1);
        ...
        viewHolder.mCategoryName.setText(mItems[position].getName());
