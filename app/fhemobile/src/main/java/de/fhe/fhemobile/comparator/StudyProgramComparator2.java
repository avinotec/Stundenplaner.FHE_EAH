 ...
 */
public class StudyProgramComparator2 implements Comparator <TimeTableStudyProgramVo2> {

	@Override
	public int compare(final TimeTableStudyProgramVo2 t1, final TimeTableStudyProgramVo2 t2) {
