...
// */
//public class CanteenImageHeaderItem extends IHeaderItem {
//
//    public CanteenImageHeaderItem(final boolean _hasSectionHeader, final int _imageRes) {
//        super(_hasSectionHeader);
//        mImageRes = _imageRes;
//    }
//
//    public CanteenImageHeaderItem(final List<IRowItem> _items, final boolean _hasSectionHeader, final int _imageRes) {
...
//    }
//
//    private static final String LOG_TAG = CanteenImageHeaderItem.class.getSimpleName();
//
