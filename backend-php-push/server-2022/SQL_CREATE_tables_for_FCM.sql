...
CREATE USER 'stundenplanuser'@'%' IDENTIFIED BY 'stundenplan2022';GRANT SELECT, INSERT, UPDATE, DELETE, FILE ON *.* TO 'stundenplanuser'@'%' REQUIRE NONE WITH MAX_QUERIES_PER_HOUR 0 MAX_CONNECTIONS_PER_HOUR 0 MAX_UPDATES_PER_HOUR 0 MAX_USER_CONNECTIONS 0;GRANT ALL PRIVILEGES ON `stundenplan`.* TO 'stundenplanuser'@'%';
...
TRUNCATE TABLE `fcm_user`;SET FOREIGN_KEY_CHECKS=1;
-- ----------------------------------------------------------------------
